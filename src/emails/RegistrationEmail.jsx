...
export const RegistrationEmail = ({
  ...
  return (
    <Html>
      <Head />
      <Preview>Welcome to SCPC - Verify Your Registration</Preview>
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={section}>
            <Text style={text}>
              Thank you for registering with SCPC. To complete your registration, please use the following verification token:
            </Text>
