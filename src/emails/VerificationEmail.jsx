...
export const VerificationEmail = ({
  ...
  return (
    <Html>
      <Head />
      <Preview>SCPC - Email Verification Request</Preview>
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={section}>
            <Text style={text}>
               You have requested to verify your email address with SCPC. Please use the following verification token:
            </Text>
          ...
          <Section style={footer}>
            <Text style={disclaimerText}>
               If you did not request this email verification, please ignore this email.            </Text>
